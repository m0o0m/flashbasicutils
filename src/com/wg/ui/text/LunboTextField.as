package com.wg.ui.text
{
	...
	public class LunboTextField implements IUI2
	{
		private var _content:MovieClip;
		System.useCodePage = true; 
		private var txt_url:String = "assets/text/my_txt.txt"; 
		...
		private function LoadCompleteHandler(event:Event):void { 
			...
			_content.my_txt1.background = true; //文字背景颜色;
			_content.my_txt1.backgroundColor = 0x000000; 
			_content.my_txt1.border = false; 
			_content.my_txt1.borderColor = 0xff0000; 
			_content.my_txt1.text = "";
