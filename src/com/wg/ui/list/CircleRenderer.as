package com.wg.ui.list
{
	...
	public class CircleRenderer extends ItemRenderer
	{
		public function CircleRenderer(dataSource:Array,index:int)
		{
			this.mWidth = 50;
			this.mHeight = 50;
		...
		override public function drawItems():void{
			...
			bg.load(new URLRequest("assets/list/item3_single_bg.png"));
			addChild(bg);
