package  views.lvjing.yanhua4{
	...
	public class FireworksParticle4 extends AbstractParticle{

		public function FireworksParticle4() {
			// constructor code
			super();
		}
		...
		{
			//当速度很小，并且跟地面很接近的时候
			return (this.speedX * this.speedX + this.speedY * this.speedY < 20) && (Math.abs(this.y - 400) < 2);
		}
